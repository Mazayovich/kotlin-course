package org.example.kotlincourse.lesson16
...
class Fridge(val capacity: Int) {
    ...
    fun removeSectionsByType(type: String): Boolean{
        val sectionsToRemove = sections.filter { it.type == type }
        return if (sectionsToRemove.isNotEmpty()) {
...
//    }
    ...
    fun removeAllItemsByName(name: String) {
        var count = 0
